...
public interface ServiceItemMapper {
	...
	PriceType selectPriceTypeBy_id(@Param("id") Integer id, @Param("company") String company);
	
	
	Integer deletePriceTypeByid(@Param("id") Integer id, @Param("company") String company);
	
	ServiceItem selectBy_id(@Param("id") Integer id, @Param("company") String company);
	
	ServiceItem selectBy_name(@Param("name") String name, @Param("company") String company);
	
	ServiceItem selectBy_name_ec(@Param("name") String name, @Param("id") Integer id, @Param("company") String company);
