...
class ResDataPath {
	...
	public static ROOT_WAR = ResDataPath.ROOT + "war/"
	public static ROOT_MOVIE = ResDataPath.ROOT + "movie/"
	public static ROOT_RIDE = ResDataPath.ROOT + "ride/"
	...
	public static GetMapPreviewPath(name: string, pic: string, type: string) {
		return "resource/assets/map/" + name + "/pk_preview_" + name + "." + type;
	}
	...
	// 获取地图资源路径
	public static GetMapPath(name: string, sub: string, x: number, y: number, type: string): string {
		return "resource/assets/map/" + name + "/" + sub + "/" + y + "_" + x + "." + type;
	}
	...
	public static GetMeriPointImgPath(name: string): string {
		return ResDataPath.ROOT + "meridianWin/" + name
	}
