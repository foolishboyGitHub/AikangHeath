window.skins=window.skins||{};
	...
	function btnShopbotLeft() {
		_super.call(this);
		this.skinParts = ["rect_rightbot","group_leftbot","labelDisplay","redPoint"];
		
		this.currentState = "up";
		this.height = 105;
		this.width = 500;
		this.elementsContent = [this.group_leftbot_i(),this.labelDisplay_i(),this.redPoint_i(),this._Rect2_i()];
		this.states = [
			new eui.State ("up",
				[
				])
	...
	function login() {
		_super.call(this);
		this.skinParts = ["_input_company","_input_username","_input_password","_loginBtn","btn_navito","revmsg"];
	...
	_proto._Group2_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 600;
		t.elementsContent = [this._Image1_i(),this._Group1_i(),this._loginBtn_i(),this.btn_navito_i(),this.revmsg_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto.group_asknum_i = function () {
		...
		t.height = 1280;
		t.width = 720;
		t.elementsContent = [this._Rect1_i(),this._Rect2_i(),this._Rect3_i(),this._Label1_i(),this._radio_num_0_i(),this._radio_num_1_i(),this._radio_num_2_i(),this._radio_num_3_i(),this._radio_num_4_i(),this._radio_num_5_i(),this._radio_num_6_i(),this._radio_num_7_i(),this._radio_num_8_i(),this._btn_more_i()];
		return t;
	};
	_proto._Rect1_i = function () {
		var t = new eui.Rect();
	...
	function ShopMakeInfoItem() {
		_super.call(this);
		this.skinParts = ["pic_item","lab_itemname","lab_itemtime","lab_itemprice","_btn_del","lab_waitetime","lab_num"];
		
		this.height = 150;
		this.width = 710;
		this.elementsContent = [this._Rect1_i(),this._Rect2_i(),this.pic_item_i(),this.lab_itemname_i(),this.lab_itemtime_i(),this.lab_itemprice_i(),this._btn_del_i(),this.lab_waitetime_i(),this.lab_num_i()];
	}
	...
	_proto.labelPerName_i = function () {
		...
		t.horizontalCenter = 0;
		t.size = 18;
		t.text = "每一个服务对象会有一名服务人员";
		t.textAlign = "center";
		t.textColor = 0xa85846;
		t.verticalAlign = "middle";
		t.width = 400;
		t.y = 15;
		return t;
	...
	function ShopMakeOrderItem() {
		_super.call(this);
		this.skinParts = ["pic_item","lab_itemname","lab_itemtime","lab_itemprice","lab_waitetime","lab_num"];
		
		this.height = 150;
		this.width = 710;
		this.elementsContent = [this._Rect1_i(),this._Rect2_i(),this.pic_item_i(),this.lab_itemname_i(),this.lab_itemtime_i(),this.lab_itemprice_i(),this.lab_waitetime_i(),this.lab_num_i()];
	}
	...
	function ShopMakeOrderListSkin() {
		_super.call(this);
		this.skinParts = ["lab_companyname","lab_billnumber","labelPerName","listGuke","group_shopMail","group_shoplist","_btn_showmore","_btn_showless","group_buttoninfo","scrollMy"];
	...
	function ShopPangeItem() {
		_super.call(this);
		this.skinParts = ["pic_itempic","lab_itemname","lab_itemtime","lab_itemprice","_btn_order"];
		
		this.height = 160;
		this.width = 720;
		this.elementsContent = [this._Rect1_i(),this._Rect2_i(),this.pic_itempic_i(),this.lab_itemname_i(),this.lab_itemtime_i(),this.lab_itemprice_i(),this._btn_order_i()];
	}
	...
	function ShopPangeSkin() {
		_super.call(this);
		this.skinParts = ["pic_companypic","lab_companyname","lab_companydress","lab_companyphone","listItem_s","scrollMy_s"];
	...
	_proto._Group1_i = function () {
		...
		t.percentWidth = 100;
		t.y = 0;
		t.elementsContent = [this._Rect2_i(),this.pic_companypic_i(),this.lab_companyname_i(),this.lab_companydress_i(),this.lab_companyphone_i()];
		return t;
	};
	_proto._Rect2_i = function () {
		var t = new eui.Rect();
	...
	_proto.pic_companypic_i = function () {
		var t = new eui.Image();
		this.pic_companypic = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		t.height = 200;
		t.right = 20;
