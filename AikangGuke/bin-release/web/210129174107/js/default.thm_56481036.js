window.skins=window.skins||{};
	...
	return BtnSave01;
})(eui.Skin);generateEUI.paths['resource/eui_skins/base/btn/btnserach.exml'] = window.btnserach = (function (_super) {
	__extends(btnserach, _super);
	function btnserach() {
		_super.call(this);
		this.skinParts = ["labelDisplay","redPoint"];
		...
		this.states = [
			new eui.State ("up",
				[
					...
					new eui.SetProperty("_Rect1","strokeColor",0x5b434f),
					new eui.SetProperty("_Rect1","strokeWeight",0),
					new eui.SetProperty("_Rect1","fillColor",0xba7328),
					new eui.SetProperty("labelDisplay","size",26),
					new eui.SetProperty("labelDisplay","textColor",0xf9f9f9)
				])
			,
			new eui.State ("down",
				[
					new eui.SetProperty("_Rect1","strokeWeight",2),
					new eui.SetProperty("_Rect1","fillAlpha",1),
					new eui.SetProperty("_Rect1","fillColor",0x754f29),
					new eui.SetProperty("labelDisplay","horizontalCenter",0),
					new eui.SetProperty("labelDisplay","verticalCenter",0),
					new eui.SetProperty("labelDisplay","size",30),
					new eui.SetProperty("labelDisplay","textColor",0xefe9e3),
	...
	var _proto = btnserach.prototype;
	...
	_proto._Rect1_i = function () {
		...
		t.ellipseWidth = 3;
		t.fillAlpha = 1;
		t.fillColor = 0xba7328;
		t.percentHeight = 100;
		t.strokeColor = 0xba7328;
		t.percentWidth = 100;
		return t;
	};
	_proto.labelDisplay_i = function () {
	...
	function login() {
		_super.call(this);
		this.skinParts = ["_input_company","_input_username","_input_password","group_company","_loginBtn","revmsg","group_login"];
	...
	_proto.group_login_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 600;
		t.elementsContent = [this._Image1_i(),this.group_company_i(),this._loginBtn_i(),this.revmsg_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto.group_company_i = function () {
		var t = new eui.Group();
		this.group_company = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		t.height = 285;
		t.horizontalCenter = 0;
	...
	_proto.group_asknum_i = function () {
		...
		t.height = 1280;
		t.width = 720;
		t.elementsContent = [this._Rect1_i(),this._Group1_i(),this._Rect2_i(),this._Rect3_i(),this._Label2_i(),this._Scroller1_i(),this._btn_more_i()];
		return t;
	};
	_proto._Rect1_i = function () {
		var t = new eui.Rect();
	...
	_proto.group_more_i = function () {
		...
		t.visible = false;
		t.percentWidth = 100;
		t.elementsContent = [this._Rect4_i(),this._Rect5_i(),this._Label3_i(),this._Rect6_i(),this.lab_gukenum_i(),this._Label4_i(),this._btn_sure_i(),this._btn_cancel_i()];
		return t;
	};
	_proto._Rect4_i = function () {
		var t = new eui.Rect();
	...
	_proto.group_time_i = function () {
		...
		t.visible = false;
		t.percentWidth = 100;
		t.elementsContent = [this._Rect7_i(),this._Rect8_i(),this._Label5_i(),this._radio_time_now_i(),this._radio_time_yuyue_i()];
		return t;
	};
	...
	_proto.group_last_i = function () {
		...
		t.visible = false;
		t.percentWidth = 100;
		t.elementsContent = [this._Rect9_i(),this._Rect10_i(),this._Label6_i(),this._radio_last_old_i(),this._radio_last_new_i()];
		return t;
	};
...
})(eui.Skin);generateEUI.paths['resource/eui_skins/shoppage/ShopSerchForCompany.exml'] = window.ShopSerchForCompany = (function (_super) {
	__extends(ShopSerchForCompany, _super);
	function ShopSerchForCompany() {
		_super.call(this);
		this.skinParts = ["elab_serach","btn_serach","lab_guessyou","listorder","scrollMy"];
		
		this.height = 1280;
		this.width = 720;
		this.elementsContent = [this._Rect1_i(),this._Group1_i(),this._Group2_i(),this._Group3_i(),this.scrollMy_i()];
	}
	var _proto = ShopSerchForCompany.prototype;
	...
	_proto._Group1_i = function () {
		...
		t.percentHeight = 100;
		t.percentWidth = 100;
		t.elementsContent = [this._Rect2_i(),this._Rect3_i(),this._Label1_i(),this._Label2_i()];
		return t;
	};
	_proto._Rect2_i = function () {
		var t = new eui.Rect();
		t.ellipseHeight = 60;
		t.ellipseWidth = 60;
		t.fillColor = 0xe5c920;
		t.height = 220;
		t.strokeColor = 0xe5c920;
		t.percentWidth = 100;
		t.y = 0;
		return t;
	};
	...
	_proto._Group2_i = function () {
		...
		t.percentWidth = 100;
		t.y = 180;
		t.elementsContent = [this._Rect4_i(),this._Image1_i(),this.elab_serach_i(),this.btn_serach_i()];
		return t;
	};
	_proto._Rect4_i = function () {
		var t = new eui.Rect();
	...
	_proto.elab_serach_i = function () {
		var t = new eui.EditableText();
		this.elab_serach = t;
		t.height = 40;
		t.size = 22;
		t.text = "门店名称，地址等...";
		t.textColor = 0xafa8a8;
		t.verticalAlign = "middle";
		t.width = 330;
		t.x = 152;
		t.y = 29;
	...
	_proto.btn_serach_i = function () {
		var t = new eui.Button();
		this.btn_serach = t;
		t.height = 50;
		t.label = "搜索";
		t.skinName = "btnserach";
		t.width = 150;
		t.x = 496;
		t.y = 24;
		return t;
	...
	_proto._Group3_i = function () {
		...
		t.percentWidth = 100;
		t.y = 315;
		t.elementsContent = [this._Label3_i(),this.lab_guessyou_i()];
		return t;
	};
	_proto._Label3_i = function () {
		var t = new eui.Label();
	...
	_proto.lab_guessyou_i = function () {
		var t = new eui.Label();
		this.lab_guessyou = t;
		t.anchorOffsetX = 0;
		t.fontFamily = "SimHei";
	...
	_proto.listorder_i = function () {
		var t = new eui.List();
		this.listorder = t;
		t.itemRendererSkinName = ShopSerchForCompanyItem;
		t.layout = this._VerticalLayout1_i();
		t.dataProvider = this._ArrayCollection1_i();
		return t;
	};
	...
	return ShopSerchForCompany;
})(eui.Skin);generateEUI.paths['resource/eui_skins/shoppage/ShopSerchForCompanyItem.exml'] = window.ShopSerchForCompanyItem = (function (_super) {
	__extends(ShopSerchForCompanyItem, _super);
	function ShopSerchForCompanyItem() {
		_super.call(this);
		this.skinParts = ["lab_company","group_companypic","lab_adress"];
		
		this.height = 220;
		this.width = 660;
		this.elementsContent = [this._Rect1_i(),this._Group2_i()];
	}
	var _proto = ShopSerchForCompanyItem.prototype;
	...
	_proto._Group2_i = function () {
		...
		t.percentHeight = 100;
		t.percentWidth = 100;
		t.elementsContent = [this.lab_company_i(),this._Group1_i(),this._Rect2_i()];
		return t;
	};
	_proto.lab_company_i = function () {
		var t = new eui.Label();
		this.lab_company = t;
		t.anchorOffsetX = 0;
		t.fontFamily = "SimHei";
	...
	_proto._Group1_i = function () {
		...
		t.percentWidth = 100;
		t.y = 60;
		t.elementsContent = [this.group_companypic_i(),this.lab_adress_i()];
		return t;
	};
	_proto.group_companypic_i = function () {
		var t = new eui.Group();
	...
	return ShopSerchForCompanyItem;
})(eui.Skin);generateEUI.paths['resource/eui_skins/shoppage/ShopSerchForCompanyOnSerach.exml'] = window.ShopSerchForCompanyOnSerach = (function (_super) {
	__extends(ShopSerchForCompanyOnSerach, _super);
	function ShopSerchForCompanyOnSerach() {
		_super.call(this);
		this.skinParts = ["listorder","scrollMy","btn_back"];
		
		this.height = 1280;
		this.width = 720;
		this.elementsContent = [this._Rect1_i(),this._Group1_i(),this.scrollMy_i(),this.btn_back_i()];
	}
	var _proto = ShopSerchForCompanyOnSerach.prototype;
	...
	return ShopSerchForCompanyOnSerach;
