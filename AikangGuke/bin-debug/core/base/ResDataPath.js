...
var ResDataPath = (function () {
    ...
    ResDataPath.GetMapPreviewPath = function (name, pic, type) {
    ...
    // 获取地图资源路径
    ResDataPath.GetMapPath = function (name, sub, x, y, type) {
    ...
    ResDataPath.GetMeriPointImgPath = function (name) {
    ...
    ResDataPath.ROOT_WAR = ResDataPath.ROOT + "war/";
    ResDataPath.ROOT_MOVIE = ResDataPath.ROOT + "movie/";
    ResDataPath.ROOT_RIDE = ResDataPath.ROOT + "ride/";
    ...
    ResDataPath._HeroEquipDefaultIcon = {};
    return ResDataPath;
}());
